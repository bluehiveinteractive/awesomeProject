 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'SDH234sfjsSfk20295854ackiw2SCBN1285jcs8p');
 ...
 */
define('TARGET_DIR', '/home/bluehive/public_html/dev/awesomeProject/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/home/bluehive/public_html/dev/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
